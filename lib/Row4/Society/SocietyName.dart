import 'package:ecampus/Row4/Society/SocietyCategory.dart';
...
class SocietyName extends StatefulWidget {
  @override
...
class _SocietyName extends State<SocietyName> {
  var txt = '';
            ...
            Column(
              children: [
                Container(
                  ...
                  margin: EdgeInsets.only(
                      left: screenWidth * 0.042, right: screenWidth * 0.019),
                  child: Text(
